  ...
  const categories = [
    {
      ...
      fallback: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=188&h=250&fit=crop'
    },
    {
      id: 2,
      name: 'Fortnite',
      ...
      fallback: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=188&h=250&fit=crop'
    },
    {
      id: 3,
      ...
      fallback: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=188&h=250&fit=crop'
    },
    {
      id: 4,
      ...
      fallback: 'https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=188&h=250&fit=crop'
    },
    {
      id: 5,
      name: 'Valorant',
      ...
      fallback: 'https://images.unsplash.com/photo-1535223289827-42f1e9919769?w=188&h=250&fit=crop'
    },
    {
      id: 6,
      name: 'Minecraft',
      ...
      fallback: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=188&h=250&fit=crop'
    },
    {
      id: 7,
      ...
      fallback: 'https://images.unsplash.com/photo-1560253023-3ec5d502959f?w=188&h=250&fit=crop'
    },
    {
      id: 8,
      name: 'Apex Legends',
    ...
    },
    {
      ...
      fallback: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=188&h=250&fit=crop'
    },
    {
      id: 16,
      name: 'Among Us',
    ...
    },
    {
      ...
      name: 'PEAK',
      viewers: '15K',
      image: 'https://static-cdn.jtvnw.net/ttv-boxart/1081998272_IGDB-285x380.jpg',
      fallback: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=188&h=250&fit=crop'
    },
    {
      id: 18,
      name: 'DEVOUR',
      viewers: '12K',
      image: 'https://static-cdn.jtvnw.net/ttv-boxart/836519689_IGDB-144x192.jpg',
      fallback: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=188&h=250&fit=crop'
    }
  ];
            ...
            {categories.map(category => (
              <div key={category.id} className="category-card">
                ...
                <div className="category-info">
                  ...
                  <p className="category-viewers">{category.viewers} espectadores</p>
                </div>
              </div>
            ))}
          </div>
